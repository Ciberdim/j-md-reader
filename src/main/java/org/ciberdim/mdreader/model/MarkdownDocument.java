...
public class MarkdownDocument {
     ...
     * @param bodyHtml the inner body HTML content
     * @param headings the list of headings extracted from the document
     */
    public MarkdownDocument(File file, String rawContent, String htmlContent, String bodyHtml, List<HeadingInfo> headings) {
        this.file = file;
    ...
    /**
     * Gets the inner body HTML content (excluding layout wrapper).
     * 
